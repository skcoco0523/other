    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 col-12">
            ...
            <div class="row g-3 mt-0">
                ...
                <div class="col-6">
                    <button type="button" class="remote-button remote-button-h50" style="background-color: #ffc107;" data-button-num="3">
            ...
            <div class="row g-3 mt-1">
                <div class="col-6">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <button type="button" class="remote-button remote-button-h20" style="background-color: #f0f0f0;" data-button-num="11"></button>
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <div class="remote-label-text remote-button-str1">切タイマー</div>
                        <button type="button" class="remote-button remote-button-h20" style="background-color: #f0f0f0;" data-button-num="12"></button>
                    </div>
                </div>
            </div>
